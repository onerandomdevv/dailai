...
export default function CallButton() {
  ...
  const handleCall = async () => {
    console.log("[CallButton] handleCall triggered");
    console.log("[CallButton] Phone number:", phoneNumber);
    ...
    try {
      console.log("[CallButton] Calling initiateCall API...");
      const result = await initiateCall(phoneNumber);
      console.log("[CallButton] API response:", result);
